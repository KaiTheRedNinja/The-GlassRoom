...
extension GlobalCoursesDataManager {
    class CoursesConfiguration: ObservableObject, Codable {
        ...
        public func loadFromUrl(url: URL) -> CoursesConfiguration? {
            ...
            guard let decodeSelf = try? JSONDecoder().decode(CoursesConfiguration.self, from: uncompressed as Data) else {
        ...
        public func loadIntoSelf(config: CoursesConfiguration) {
